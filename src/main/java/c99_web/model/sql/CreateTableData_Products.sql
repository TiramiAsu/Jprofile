...
CREATE TABLE ICProducts(
    pd_code varchar(10) primary key, -- 主鍵(產品代號)
...
INSERT INTO JAVAWEB.ICPRODUCTS (PD_CODE, PD_NAME, PD_PRICE, PD_COST, PD_UNIT, PD_STATUS, PD_REMARK) 
 VALUES ('A001', '漢堡', 50, 22, '個', 'Y', '賺'),
        ('A002', '薯條', 30, 10, '包', 'Y', '賺翻了'),
        ('A003', '雪碧', 40, 5, '杯', 'Y', '賺翻了個大白眼'),
        ('A004', '可樂', 30, 15, '杯', 'N', '沒什麼好說的'),
        ('K852', '蘋果派', 60, 19, '個', 'N', '蘋果沒了'),
        ('A007', '黑漢堡', 79, 40, '個', 'N', ''),
        ('F085', '冰炫風', 45, 16, '杯', 'Y', ''),
        ('D852', '薯餅', 40, 10, '個', 'Y', '現做');
